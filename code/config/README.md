...
- `model_config.yaml`의 `official_comparison_models`는 Global과 Local의 공식 비교 대상만 정한다. 다른 `models:` 항목은 기존 코드 호환성을 위해 유지한다.
...
| `official_comparison_models`의 Global·Local LR·XGBoost 목록 | **사람(Kim ByungKyu)이 직접 지시한 2026-08-20 모델링 준비 결정** | ✅ 2026-08-20 Kim ByungKyu |
